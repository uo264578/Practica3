...
class TiempoLogroño {
    ...
    loadData() {
		this.url = "http://api.openweathermap.org/data/2.5/weather?q=Logroño,ES&units=metric&lang=es&APPID=4830b142824dfabb55755d9388e59d88";
        $.ajax({
            dataType: "json",
            url: this.url,
            method: 'GET',
            ...
            error: function () {
                alert("No se puede abrir el tiempo en Logroño");
            }
		});
    }
...
class TiempoTarifa {
    ...
    loadData() {
		this.url = "http://api.openweathermap.org/data/2.5/weather?q=Tarifa,ES&units=metric&lang=es&APPID=4830b142824dfabb55755d9388e59d88";
        $.ajax({
            dataType: "json",
            url: this.url,
            method: 'GET',
...
class TiempoSalamanca{
    ...
    loadData() {
		this.url = "http://api.openweathermap.org/data/2.5/weather?q=Salamanca,ES&units=metric&lang=es&APPID=4830b142824dfabb55755d9388e59d88";
        $.ajax({
            dataType: "json",
            url: this.url,
            method: 'GET',
