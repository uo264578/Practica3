    ...
    cargarDatos(){
        $.ajax({
            ...
            success: function(datos){
			    ...
			    let h2 = $("h2");
				h2.append("XML Cargado");
                $("h3").text((new XMLSerializer()).serializeToString(datos));
...
var tiempoLogroño = new TiempoLogroño();
...
var tiempoMalaga = new TiempoMalaga();
...
var tiempoGijon = new TiempoGijon();
...
var tiempoSevilla = new TiempoSevilla();
